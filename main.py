...
def main():
    ...
    group.add_argument("-fdg", "--fdeg", help = "Converts angle from radians to degrees", action = "store_true")
    group.add_argument("-frd", "--frad", help = "Converts angle from degrees to radians", action = "store_true")
    ...
    if args.fadd:
        ...
        print("Tangent of {} radians is {}".format(args.num1,(tan(args.num1))))
    elif args.fdeg:
        print("{} radians to degrees is {}".format(args.num1,(deg(args.num1))))
    elif args.frad:
        print("{} degrees to radians is {}".format(args.num1,(rad(args.num1))))
    else:
